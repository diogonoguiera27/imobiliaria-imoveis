      ...
      <form className="!space-y-0" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-4">
          ...
          <Input
            ...
            {...register('nome')}
            className="w-full !px-4 !py-1.5 !bg-red-800 !text-white border !border-red-300 !rounded-full !placeholder-red-300 !focus:outline-none"
          />
          <p className="text-red-300 text-sm min-h-[16px]">
            {errors.nome?.message}
          </p>
        </div>
