...
import { LayoutDashboard, User, Building2, PlusSquare, Home, Phone, Users } from "lucide-react";
...
export default function MobileBottomBar() {
  ...
  return (
    <div
      className="!fixed !bottom-0 !left-0 !w-full !bg-gradient-to-r 
                 !from-red-400 !to-red-700 !shadow-[0_-2px_8px_rgba(0,0,0,0.2)]
                 !flex !justify-between !px-10 !py-2 md:!hidden z-[60]"
    >
      {/* Ícone ADMIN */}
      {isAdmin && (
        <Sheet>
