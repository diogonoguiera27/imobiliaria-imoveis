...
import {
  ...
  Phone,
  Users,
  Briefcase, // Novo ícone opcional para corretor
} from "lucide-react";
...
export default function MobileBottomBar() {
  ...
  if (!role) return null; // só exibe se logado
  ...
  return (
    <div
      ...
      "
    >
      {/* ====== MENU ADMIN ou CORRETOR (lado esquerdo) ====== */}
          ...
          <SheetTrigger asChild>
            ...
            >
              {role === "ADMIN" ? (
                ...
                <Briefcase className="!w-6 !h-6 sm:!w-7 sm:!h-7" /> // Ícone de corretor
              )}
            </Button>
          </SheetTrigger>
