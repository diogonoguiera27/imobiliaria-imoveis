...
import PerfilUsuarioModal from "@/components/UserProfileModal";
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
function Sidebar({
  ...
  // Use Sheet component for all screen sizes
  return (
    <Sheet
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-muted-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
